...
{
    public sealed class SupplierTaxIdVO : IValueObject
    {
        public string Value { get; private set; }

        private SupplierTaxIdVO(string value)
        {
            Value = value;
        }

        public static SupplierTaxIdVO Create(string taxId)
        {
